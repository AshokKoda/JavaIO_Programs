...
enum EFileNames {
	FILE_NAME1("File1.txt"), FILE_NAME2("File2.txt"), FILE_NAME3("File3.txt"), FILE_NAME4("File4.txt"),
...
public class EmployeePayrollService {
	...
	public static void listAllFiles() {
		File file = new File("D:/Eclipse Java Projects/eclipse-workspace/Java_IO_Programs");
